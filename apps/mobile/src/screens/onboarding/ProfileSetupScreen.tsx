  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top", "bottom"]}>
      ...
      <View className="px-6 pt-4" style={{ gap: 4 }}>
        <Text className="text-2xl font-semibold text-slate-900">{t("profileSetup.title")}</Text>
        <Text className="text-body text-slate-500">{t("profileSetup.subtitle")}</Text>
      </View>

      <View className="px-6 pt-8" style={{ gap: 16 }}>
        <View style={{ gap: 6 }}>
          <Text className="text-body font-semibold text-slate-700">{t("profileSetup.fullName")}</Text>
          <TextInput
            value={name}
        ...
        <View style={{ gap: 6 }}>
          <Text className="text-body font-semibold text-slate-700">{t("profileSetup.email")}</Text>
          <TextInput
            value={email}
